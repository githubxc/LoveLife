                ...
                if (imageSize != null) {
                    ...
                    smallImageView.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public boolean onLongClick(View view) {
                            Toast.makeText(ImagePagerActivity.this, "长按", Toast.LENGTH_SHORT).show();
                            return true;
                        }
                    });
...
//                loadingLayoutParams.gravity = Gravity.CENTER;
                ...
                //loading.setProgressDrawable(ContextCompat.getDrawable(context, R.color.colorAccent));
                ...
                //GlideUtil.load(context, imgurl, imageView, options);
                Glide.with(context)
                        .load(imgurl)
                        .thumbnail(0.1f)
                        .apply(options)
                        .into(imageView);
//                Glide.with(context).load(imgurl).(DiskCacheStrategy.ALL)//缓存多个尺寸
